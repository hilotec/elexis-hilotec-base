...
import ch.elexis.hl7.HL7Parser;
...
public class HL7_ORU_R01 extends HL7Parser {
	...
	public ObservationMessage readObservation(final String text) throws IOException,
		...
		if (oru != null) {
			...
			for (int j = 0; j < obscount; j++) {
				...
				if (orderCommentNTE != null) {
					observation.add(new TextData(COMMENT_NAME, orderCommentNTE,
						obrDateOfObservation, COMMENT_GROUP, null));
				}
