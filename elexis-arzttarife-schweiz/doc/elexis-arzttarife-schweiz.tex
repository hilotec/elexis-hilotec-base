...
% *
% *  $Id: elexis-arzttarife-schweiz.tex 3939 2008-05-19 17:19:40Z rgw_ch $
% *******************************************************************************/
...
\begin{figure}
    \center
  % Requires \usepackage{graphicx}
  \includegraphics[width=0.75\textwidth]{abr4}\\
...
\subsubsection{Fall-Erfordernisse}
\label{fall-erfordernisse}
\begin{figure}
  % Requires \usepackage{graphicx}
  \includegraphics[width=0.9\textwidth]{abr8}\\
