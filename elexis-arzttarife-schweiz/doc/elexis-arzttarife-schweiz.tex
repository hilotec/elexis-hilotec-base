...
% *
% *  $Id: elexis-arzttarife-schweiz.tex 5156 2009-02-20 19:53:54Z rgw_ch $
% *******************************************************************************/
...
\extratitle{
    ...
    \vfill
    \begin{center}
   \copyright 2008-2009 by G.Weirich. Nachdruck und Weitergabe, auch auszugsweise, sowohl in elektronischer als auch in Papierform, nur mit Genehmigung des Autors.
...
\index{Abrechnungssystem}\index{UVG}\index{KVG}\index{VVG}\index{Privatrechnung}
...
. Dabei können Sie die beiden XML Felder (ean provider, ean responsible) sowohl als Fallkonstante oder bei den Notwendigen Daten erfassen. Der Unterschied liegt darin, dass Fallkonstante automatisch in die Rechnung übernommen werden und die Notwendigen Daten pro Fall individuell erfasst werden müssen. Das Beispiel in Abb.\ref{fig:abr25} führt also die ausführende Person als Fallkonstante und die verantwortliche Person als Variable pro Fall.\linebreak
