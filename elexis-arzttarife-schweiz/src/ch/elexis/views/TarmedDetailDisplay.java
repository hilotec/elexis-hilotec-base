...
public class TarmedDetailDisplay implements IDetailDisplay {
	...
	private String[] fields={Messages.TarmedDetailDisplay_DigniQuant,Messages.TarmedDetailDisplay_DigniQual,Messages.TarmedDetailDisplay_Sparte,
							 Messages.TarmedDetailDisplay_RiskClass,Messages.TarmedDetailDisplay_TPDoc,
							 Messages.TarmedDetailDisplay_TPTec, Messages.TarmedDetailDisplay_TPAss,
                             Messages.TarmedDetailDisplay_NumbereAss,Messages.TarmedDetailDisplay_TimeAct,
							 Messages.TarmedDetailDisplay_TimeBeforeAfter,Messages.TarmedDetailDisplay_TimeWrite, Messages.TarmedDetailDisplay_TimeChange,Messages.TarmedDetailDisplay_TimeRoom,
	...
	public void display(Object obj) {
		if(obj instanceof TarmedLeistung){
	        ...
	        inputs[3].setText(TarmedLeistung.getTextForRisikoKlasse((String)ext.get("ANAESTHESIE"))); //$NON-NLS-1$
