...
public class OOPrefs extends FieldEditorPreferencePage implements
	...
	protected void createFieldEditors() {
		addField(new BooleanFieldEditor(SHOW_MENU, "Menü anzeigen",
				getFieldEditorParent()));
		addField(new BooleanFieldEditor(SHOW_TOOLBAR, "Toolbar anzeigen",
				getFieldEditorParent()));
		dfe=new DirectoryFieldEditor(PreferenceConstants.P_OOBASEDIR,
				"OOo-Programmverzeichnis",getFieldEditorParent());
		addField(dfe);
	}
	...
	public boolean performOk() {
		...
		try {
			...
			OutputStreamWriter or=new OutputStreamWriter(new FileOutputStream(outfile),"iso-8859-1");
			String in;
