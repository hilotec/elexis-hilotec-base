...
public class OOWrapper {
    ...
    /**
     * Lädt ein template,speichert es am angegebenen Ziel unter neuem Namen und öffnet 
     * ein OpenOffice-Fenster mit diesem File
     * @param template Pfadname eines existierenden Files als Schablone
     * @param Pfadname des mit der Schablone zu erstellenden Zielfiles
	...
	public XTextDocument createTextFile(String template, String dest){
		...
		try {
          ...
          Object oDocToStore = xCompLoader.loadComponentFromURL(
              sLoadUrl, "_blank", 0, propertyValue );
          ...
          */
          ...
          com.sun.star.lang.XComponent xComp = xCompLoader.loadComponentFromURL(
              sSaveUrl, "_blank", 0, new com.sun.star.beans.PropertyValue[0]);
          
          XTextDocument xDoc = (com.sun.star.text.XTextDocument)
