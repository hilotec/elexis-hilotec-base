...
public class OOPrinter {
	...
	public void printDocument(String printer, String file, String tray) {
		try {
			...
			XComponent xComp = xCompLoader.loadComponentFromURL(sUrl.toString(), 
					"_blank", 0, loadDesc);
...
//		my PageStyleSetting ...
	...
	/*
	private void printDocument(String printer, String file) {
		try {
			java.io.File sourceFile = new java.io.File(Constants.workingDirectory + file);
			StringBuffer sUrl = new StringBuffer("file:///");
			sUrl.append(sourceFile.getCanonicalPath().replace('\\', '/'));
...
//			Loading the wanted document
			com.sun.star.lang.XComponent xComp = xCompLoader.loadComponentFromURL(sUrl.toString(), "_blank", 0, loadDesc);
			
//			Querying for the interface XPrintable on the loaded document
			com.sun.star.view.XPrintable xPrintable = (com.sun.star.view.XPrintable) UnoRuntime.queryInterface(com.sun.star.view.XPrintable.class, xComp);
