...
public class Mailer {
	 ...
	 * @param recipient	empfänger-Email
	...
	public static Result<String> postMail( String recipient, String subject, String message, String from ) {
		try{
			...
			ExHandler.handle(ex);
			return new Result<String>(Log.ERRORS,1,ex.getMessage(),Messages.Mailer_Error,true);
		}
	}
	
	/**
	 * Eine vorerst leere Mime/Multipart Nachricht erstellen. Danach kann beliebig oft unt
	 * gemischt addTextPart(), addBinaryPart() und addFilePart() aufgerufen werden, und am Schluss
	 * send()
	 * @param subject Titel
	 * @param from Absender
	 * @return die Message
	 ...
	 * @param text der Text für den Part
	 ...
	 * @param msg die Nachricht
	 * @param name Name für die Part
	 * @param part die Daten, die angehängt werden sollen
	 * @return true bei Erfolg
	 */
