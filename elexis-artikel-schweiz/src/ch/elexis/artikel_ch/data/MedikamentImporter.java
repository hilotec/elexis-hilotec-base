 ...
 *    
 *  $Id: MedikamentImporter.java 4463 2008-09-27 19:52:37Z rgw_ch $
 *******************************************************************************/
...
public class MedikamentImporter extends ImporterPage {
	...
	public IStatus doImport(final IProgressMonitor monitor) throws Exception {
		...
		/*
		 * if(bDelete==true){ if(SWTHelper.askYesNo("Wirklich Daten löschen",
		 * "Achtung: Wenn die alten Daten gelöscht werden, kann es\nsein, dass
		 * bestehende Bezüge ungültig werden.")){
		 * PersistentObject.getConnection().exec("DELETE FROM ARTIKEL WHERE
		 * TYP='Medikament'"); mode=" (Modus: Alles neu erstellen)"; } }
		 */
		...
		while ((in = br.readLine()) != null) {
			...
			if (reca.equals("11")) { // Stammsatz
				...
				SWTHelper
						.showError("Falsches Dateiformat",
	...
	/*
	 * @Override public void collect() { bDelete=bClear.getSelection();
	 * super.collect(); }
	 */
}
