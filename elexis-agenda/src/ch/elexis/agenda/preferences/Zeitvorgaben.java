 ...
 * Unter agenda/zeitvorgaben ist für jeden mandanten ein String der Form
 ...
 *
 */
public class Zeitvorgaben extends PreferencePage implements
	...
	protected Control createContents(Composite parent) {
		...
		bereiche=Hub.globalCfg.get(PreferenceConstants.AG_BEREICHE, Messages.Zeitvorgaben_praxis).split(","); 
