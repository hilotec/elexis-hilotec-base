...
public class DataAccessor implements IDataAccess {
	...
	/**
	 * Returns a list with the defined fields.
	 * Currently only "BeiWem" (Bereich) is supported.
	 */
	public List<Element> getList() {
		ArrayList<Element> ret = new ArrayList<Element>();
		ret.add(new IDataAccess.Element(IDataAccess.TYPE.STRING, 
										"Bereich", //$NON-NLS-1$
										getPlatzhalter(Termin.FLD_BEREICH),
										Termin.class, 
										1 )); 
		return ret;
	}
	...
	public Result<Object> getObject(String descriptor,PersistentObject dependentObject, String dates, String[] params) {
		...
		if( descriptor.equals(Termin.FLD_BEREICH) ) {
			PersistentObject selectedTermin = (PersistentObject) ElexisEventDispatcher.getSelected(Termin.class);
