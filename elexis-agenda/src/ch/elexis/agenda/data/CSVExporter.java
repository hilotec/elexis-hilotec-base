...
public class CSVExporter {
	...
	public void doExport(String filename, List<Termin> termine) {
		try{
			...
			String[] fields=new String[]{"ID", Termin.FLD_BEREICH, Termin.FLD_TERMINTYP,Termin.FLD_TAG, Termin.FLD_BEGINN,Termin.FLD_DAUER,
					Termin.FLD_GRUND,	Termin.FLD_PATIENT};
