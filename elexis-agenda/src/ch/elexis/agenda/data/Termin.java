...
public class Termin extends PersistentObject implements Cloneable, Comparable<Termin>, IPlannable {
	...
	static {
		addMapping("AGNTERMINE", "BeiWem=Bereich", "Wer=PatID", "Tag", "Beginn", "Dauer", "Grund",
			...
			"lastedit", "PalmID", "flags", "deleted", "Extension", "linkgroup");
	...
	public Termin(final String bereich, final String Tag, final int von, final int bis,
		...
		set(new String[] {
			"BeiWem", "Tag", "Beginn", "Dauer", "Typ", "Status", "ErstelltWann", "lastedit"
	 ...
	 * create(null); String ts=getTimeStamp(); set(new
	 * String[]{"BeiWem","Tag","Beginn","Dauer","Typ","Status","ErstelltWann","lastedit"},
	 * BeiWem.getId(),Tag,Integer.toString(von),Integer.toString(bis-von), typ,status,ts,ts); }
	 */
	@Override
	public Object clone(){
		Termin ret =
			new Termin(get("BeiWem"), get("Tag"), getStartMinute(), getStartMinute() + getDauer(),
				getType(), getStatus());
	...
	public void set(final String bereich, final String tag, final int von, final int bis,
		...
		if (!checkLock()) {
			set(new String[] {
				"BeiWem", "Tag", "Beginn", "Dauer", "Typ", "Status", "lastedit"
	...
	public void set(final String bereich, final TimeTool wann, final int dauer, final String typ,
		...
		set(new String[] {
			"BeiWem", "Tag", "Beginn", "Dauer", "Typ", "Status", "Wer", "Grund", "lastedit"
	...
	public boolean isEqual(final Termin ae){
		return super.isMatching(ae, 0, "Tag", "Beginn", "Dauer", "BeiWem", "Typ", "Status",
			"ErstelltVon", "Wer");
	}
	...
	public String getLabel(){
		...
		sb.append(ts.from.toString(TimeTool.TIME_SMALL)).append("-").append(
			ts.until.toString(TimeTool.TIME_SMALL)).append(" ").append(getPersonalia())
