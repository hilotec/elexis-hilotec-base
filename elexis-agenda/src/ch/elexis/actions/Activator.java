...
/**
 * Einen Activator braucht man immer dann, wenn man irgendwelche Dinge
 * sicher zu Beginn der Plugin-Aktivierung ausgeführt haben will.
 * Wir verwenden das hier, um die AgendaActions zu initialisieren. 
 */
public class Activator extends AbstractUIPlugin {
	...
	public static String getBasePath(){
    	URL url=null;
		try {
			url = Platform.asLocalURL(new URL(FileTool.getClassPath(Activator.class)));
