...
public class Artikel_AT_Cache {
	...
	private static void initialize() {
		if(!initialized) {
			...
			if(artikelATcache == null) {
				...
				if(resultSet == null) resultSet = new HashMap<Integer, String>();
				loadCache();
			}
			initialized = true;
		}
	...
	public static void updateCache() {
		if(!initialized) {
			if(artikelATcache == null) artikelATcache = new HashMap<String, HashMap<Integer, String>>();
			initialized = true;
		}
		...
		Hub.globalCfg.set(PreferenceConstants.ARTIKEL_AT_CACHEUPDATE_TIME, ts.toString(TimeTool.FULL_GER));
	}
}
