...
public class MedikamentImporterVidal extends ImporterPage {
	...
	class Handler extends org.xml.sax.helpers.DefaultHandler{
		...
		public void startElement(String uri, String localName, String qName, Attributes attr) throws SAXException {
			...
			}else if(qName.equals("PhZNr") || (qName.endsWith("Name")) 
					|| (qName.equals("DoLC")) || qName.equals("Storage")
					|| (qName.equals("Quantity")) || (qName.equals("EnhUnitDesc"))
					|| (qName.equals("KVP"))|| (qName.equals("AVP")) || (qName.equals("zInh"))
					|| (qName.equals("INDText") || (qName.equals("RuleText") 
					|| (qName.equals("RemarkText"))))){
		...
		public void endElement(String uri, String localName, String qName) throws SAXException {
			if(qName.equals("RpEntry")){
				...
				if(actType.equals(ENTRYTYPE_INSERT)){
					art=new Medikament((String)act.get("SName"),"Vidal",(String)act.get("PhZNr"));
				}else{
					qbe.clear();
					qbe.add("Typ", "=", "Vidal");
