...
import org.eclipse.swt.widgets.TypedListener;
	 ...
	 *
	 * changes by jense128 (Laurent Dutheil)
	 *  * combo box is now smaller than the calendar widget
	 *  
	 * changes by gis (Carsten Pfeiffer)
	 *  * fixed focus handling as described in bug 1187304
	 *  
	 * changes by andyglow
	...
	public final class DatePickerCombo extends Composite
	{
		...
		public DatePickerCombo(Composite parent, int style)
		{
			...
			int[] dpEvents = {SWT.MouseUp, SWT.MouseDoubleClick, SWT.Selection, SWT.Traverse,
			...
			switch (event.type)
			{
				...
				case SWT.FocusOut : {
					...
					try
					{
						...
						{
							Date date = getFormat().parse(text.getText());
							String formatedText = getFormat().format(date);
							if (text.getText().equals(formatedText))
							{
		...
		/**
		 * @param applyCellEditorFix The applyCellEditorFix to set.
		 */
