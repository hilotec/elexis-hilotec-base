 ...
 *    
 *  $Id: Samdas.java 4450 2008-09-27 19:49:01Z rgw_ch $
 *******************************************************************************/
...
/**
 * Ganz bescheiden: (S)tandard für den (A)ustausch (m)edizinischer (Da)ten in
 * der (Schweiz) -> SAmDaS. In Ermangelung eines besseren Standards sei dieser
 * Name gestattet ;-) Samdas ist ein XML-Schema, das die Übertragung
 * medizinischer Krankengeschichten (Elecronic medical record, EMR) zwischen
 * verschiedenen Endanwendungen ermöglicht. Diese Klasse ist ein API dafür
 * 
 * @author Gerry
 * 
 */
public class Samdas {
	public static final Namespace ns = Namespace.getNamespace("samdas",
			"http://www.elexis.ch/XSD");
	public static final Namespace nsxsi = Namespace.getNamespace("xsi",
			"http://www.w3.org/2001/XML Schema-instance");
	public static final Namespace nsschema = Namespace.getNamespace(
			"schemaLocation", "http://www.elexis.ch/XSD EMR.xsd");

	private Document doc;
	private Element eRoot;

	/**
	 * Der String-Konstruktor erstellt ein Samdas aus der XML-Repräsentation.
	 * Wenn diese ungültig ist, wird ein Default-Dokument erstellt.
	 * 
	 * @param input
	 *            eine XML-Datei (oder irgendein Text, der dann komplett ins
	 *            Text-Element des Standard-Dokuments eingebunden wird)
	 */
	...
	/**
	 * A Range is a part of the text. It is defined by a position, a length and
	 * a type.
	 * 
	 */
	...
	/**
	 * An XRef is a range that defines a crossreference to some other piece of
	 * information it can define a class that can handle its contents
	 * 
	 * @author Gerry
	 * 
	 */
	...
	/**
	 * A Section is a Markup that summarizes a piece of text unter a section
	 * header.
	 * 
	 * @author Gerry
	 * 
	...
	public static class Finding {
		...
		Finding(String typ, String date, String labEAN, boolean abnormal) {
			...
			el.setAttribute("abnormal", Boolean.toString(abnormal)
					.toLowerCase());
		}
