...
/**
 * A generic mediator between Elexis Objects and XML-Files. Any number of Objects can be
 * sent to the IDataSender, finishing with a call to finalizeExport. The ultimate destination
...
public interface IDataSender{
	...
	/**
	 * Send the stored objects to this IDataSender's ultimate
	 * destinaion (e.g. file, URL). The IDataTransfer is invalid after finalizing.
