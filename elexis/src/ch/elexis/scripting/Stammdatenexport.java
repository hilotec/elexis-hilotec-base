		...
		if (file != null) {
			try {
				...
				String[] header=new String[]{"UUID","Nr","Titel","Name","Vorname","Geschlecht","Geburtsdatum",
						...
						"Bemerkung"};
				String[] fields=new String[]{"ID", Patient.FLD_PATID, "Titel",Patient.NAME,Patient.FIRSTNAME,Patient.SEX,Patient.FLD_DOB,
						Patient.FLD_STREET,Patient.FLD_ZIP,Patient.FLD_PLACE,"Anschrift",Patient.FLD_PHONE1,"Telefon2","Natel",
						"Bemerkung"
				};
