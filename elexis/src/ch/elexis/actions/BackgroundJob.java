...
/**
 * Die Basis des Hintergrunddienst-Systems von Elexis. Ein Hintegrunddienst
 * muss von BackgroundJob abgeleitet werden und bei Hub.jobPool angemeldet werden.
 * Er kann direkt oder vom JobPool aus gestartet werden und meldet seine Beendigung
 * an alle interessierten BackgroundJobListener.
 * @see JobPool
 * @author Gerry
 *
 */
public abstract class BackgroundJob extends Job {
    ...
    /***
     * Wer bei Beendigung eines BackgroundJobs benachrichtigt werden will,
     * muss einen BackgroundJobListener anmelden.
     * @author Gerry
     *
     */
    ...
    /** 
     * Einen Listener zufügen, der bei Beendigung des Jobs benachrichtigt
     * wird. Die Benachrichtigung aller angemeldeten Listener erfolgt
     * nacheinander, aber in keiner garantierten Reihenfolge.
     */
     ...
     * Listener gelöscht wird, da sonst der Versuch, diesen Listener zu 
     * benachrichtigen, eine Exception werfen würde.
     */
    ...
    /** Diesen Job auf ungültig setzen. Er muss dann zuerts mindestens einmal
     * erfolgreich beendet worden sein, bevor er wieder "valid" ist
     *
     */
