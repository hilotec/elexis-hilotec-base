...
public interface ElexisEventListener {
	...
	/**
	 * Filter the events this listener wants to be informed. Note: This call should complete
	 * as fast as possible, because it will be called with every event before dispatching
