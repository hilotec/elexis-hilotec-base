...
/**
 * BackgroundJob which loads data from the database in background. The definition
 * of the access to the data is left to tzzhe implementing class.
 * 
...
public abstract class AbstractDataLoaderJob extends BackgroundJob{
    /**
     * A FilterProvider is a class than can apply a filter to a DataLoader, that
     * controls the read data.
     * 
	 * Ein Filterprovider ist eine Klasse, die bei Bedarf einen Filter auf
	 * den Dataloader anwenden kann, welcher die zu lesenden Datensätze limitiert.
	 * @author gerry
	 *
	 */
    ...
    /**
     * set sorting order
     * Umgekehrte Sortierreihenfolge setzen
     * @param reverse true: sort reversely
     */
