...
public class PlatzhalterTreeData {
	...
	final private SortedList<PlatzhalterTreeData> childrenList = new SortedList<PlatzhalterTreeData>(new TreeComparator());
	...
	public PlatzhalterTreeData(final PlatzhalterTreeData _parent,
			final String _name, final String _key, final String _description) {
		super();
		if (parent != null) {
	...
	public PlatzhalterTreeData(final String _name, final String _key,
