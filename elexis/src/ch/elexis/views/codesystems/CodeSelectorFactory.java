 ...
 *    
 *  $Id: CodeSelectorFactory.java 5331 2009-05-30 13:01:05Z rgw_ch $
 *******************************************************************************/
...
public abstract class CodeSelectorFactory implements IExecutableExtension {
	...
	public static class cPage extends Composite implements GlobalEvents.SelectionListener {
		...
		cPage(final CTabFolder ctab, final IViewSite s, final ICodeElement v,
			...
			gUser.setText(Messages.getString("CodeSelectorFactory.yourMostFrequent")); //$NON-NLS-1$
			...
			gPatient.setText(Messages.getString("CodeSelectorFactory.patientsMostFrequent")); //$NON-NLS-1$
