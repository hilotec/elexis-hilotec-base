 ...
 *    
 *  $Id: LeistungenView.java 5096 2009-02-06 11:58:52Z rgw_ch $
 *******************************************************************************/
...
public class LeistungenView extends ViewPart implements ActivationListener,
		ISaveablePart2 {
	...
	public void activation(boolean mode) {
		if (mode == false) {
			...
			/*
			 * int idx=ctab.getSelectionIndex(); MFUList<String>
			 * mfu=Hub.actUser.getMFU("LeistungenMFU"); CTabItem[]
			 * items=ctab.getItems(); Iterator<String> it=mfu.iterator(); int
			 * i=0; while(it.hasNext()){ String tab=it.next(); for(int
			 * j=0;j<items.length;j++){ if(items[j].getText().equals(tab)){
			 * if(j!=i){ swapTabs(i,j); break; } } } i++; }
