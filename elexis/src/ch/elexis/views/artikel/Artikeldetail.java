...
public class Artikeldetail extends ViewPart implements IActivationListener,
	...
	private ElexisEventListenerImpl eeli_art = new ElexisEventListenerImpl(
			Artikel.class) {
	...
	public void createPartControl(Composite parent) {
		...
		tblArtikel = new LabeledInputField.AutoForm(form.getBody(),
				getFieldDefs(parent.getShell()));
