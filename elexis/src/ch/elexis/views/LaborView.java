 ...
 *    
 *  $Id: LaborView.java 4450 2008-09-27 19:49:01Z rgw_ch $
 *******************************************************************************/
...
public class LaborView extends ViewPart implements SelectionListener,
	...
	private void makeActions() {
		...
		fwdAction.setImageDescriptor(Hub
				.getImageDescriptor("rsc/arrow_next.gif"));
		backAction.setImageDescriptor(Hub
				.getImageDescriptor("rsc/arrow_prev.gif"));
