...
public class Patientenblatt2 extends Composite implements IActivationListener {
	...
	private final static String[] lbExpandable =
		{
			Messages.getString("Patientenblatt2.diagnosesLbl"),
			Messages.getString("Patientenblatt2.persAnamnesisLbl"),/*
																	 * "Familienanamnese",
																	 * //$NON-NLS-1$ //$NON-NLS-2$
																	 * //$NON-NLS-1$ //$NON-NLS-2$
																	 * "Systemanamnese",
	...
	private final static String[] dfExpandable = {
		"Diagnosen", "PersAnamnese",/*
									 * "FamilienAnamnese", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-1$
									 * //$NON-NLS-2$ "SystemAnamnese",
