...
class RnControlFieldProvider implements ViewerConfigurer.ControlFieldProvider{
	...
	final static int[] statInts={
		...
		RnStatus.FEHLERHAFT, RnStatus.ZU_DRUCKEN};
	...
	private SelectionAdapter csel=new CtlSelectionListener();
	...
	public Composite createControl(final Composite parent) {
		...
		ret.setLayout(new GridLayout(7,false));
		...
		expl.setLayoutData(SWTHelper.getFillGridData(6, false, 1, false));
		new Label(ret,SWT.NONE).setText(" ");
