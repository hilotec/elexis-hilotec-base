...
/**
 * This class provides a sourceProvider for Eclipse command evaluation. It can be used
 * to check whether a Patient is currently selected in the system. According to this
 * command contributions can be toggled on/off.
 * 
