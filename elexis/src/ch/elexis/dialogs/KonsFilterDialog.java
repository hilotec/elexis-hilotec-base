 ...
 *    
 *  $Id: KonsFilterDialog.java 1153 2006-10-22 19:10:08Z rgw_ch $
 *******************************************************************************/
...
public class KonsFilterDialog extends TitleAreaDialog {
	...
	protected void okPressed() {
		...
		if(!StringTool.isNothing(cc)){
			StringTool.tokenizer tk=new StringTool.tokenizer(cc," ",StringTool.tokenizer.DOUBLE_QUOTED_TOKENS);
			try {
