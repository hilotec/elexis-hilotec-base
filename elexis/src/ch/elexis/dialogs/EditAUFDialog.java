 ...
 *    
 *  $Id: EditAUFDialog.java 1153 2006-10-22 19:10:08Z rgw_ch $
 *******************************************************************************/
...
public class EditAUFDialog extends TitleAreaDialog {
	...
	protected void okPressed() {
		...
		if(auf==null){
			...
			fall=auf.getFall();
			String[] parms=new String[]{"FallID","von","bis","Grund","Prozent","Zusatz"};
			String[] vals=new String[]{fall.getId(),von,bis,tGrund.getText(),tProzent.getText(),zus};
			auf.set(parms, vals);
		}
		super.okPressed();
	}
