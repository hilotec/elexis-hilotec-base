 ...
 *    
 * $Id: DBUpdate.java 4337 2008-09-01 15:41:59Z rgw_ch $
 *******************************************************************************/
...
public class DBUpdate {
	...
	static final String[] versions = { "1.3.0", "1.3.1", "1.3.2", "1.3.3",
			"1.3.4", "1.3.5", "1.3.6", "1.3.7", "1.3.8", "1.3.9", "1.3.10",
			"1.3.11", "1.3.12", "1.3.13", "1.4.0", "1.4.1", "1.4.2", "1.4.3",
			"1.4.4", "1.4.5", "1.4.6", "1.5.0", "1.6.0", "1.6.1", "1.6.2",
			"1.6.3", "1.6.4", "1.7.0", "1.7.1", "1.7.2" };
	static final String[] cmds = {
			"CREATE TABLE EIGENLEISTUNGEN(" + "ID			VARCHAR(25) primary key,"
					+ "Code		VARCHAR(20)," + "Bezeichnung VARCHAR(80),"
					+ "EK_PREIS	CHAR(6)," + "VK_PREIS	CHAR(6),"
					+ "ZEIT		CHAR(4)	);",
			...
			"CREATE TABLE HEAP2(" + "ID			VARCHAR(50) primary key,"
					+ "Contents   BLOB);",
			...
			"ALTER TABLE HEAP ADD datum CHAR(8);"
					...
					+ "OID		VARCHAR(80)," + "datum		CHAR(8),"
					+ "typ		VARCHAR(20)," + "userID		VARCHAR(25),"
					+ "station	VARCHAR(25)," + "ExtInfo		BLOB);",

			// 1.6.1
			"CREATE TABLE XID(" + "ID			VARCHAR(25) primary key,"
					+ "deleted	CHAR(1) default '0'," + "type		VARCHAR(80),"
					+ "object		VARCHAR(25)," + "domain		VARCHAR(255),"
			...
			"CREATE TABLE ETIKETTEN("
					...
					+ "deleted		CHAR(1) default '0'," + "Datum			CHAR(8),"
					+ "Title 			VARCHAR(80)," + "Bild			BLOB" + ");"
