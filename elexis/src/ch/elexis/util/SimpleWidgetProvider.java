 ...
 *    
 *    $Id: SimpleWidgetProvider.java 23 2006-03-24 15:36:01Z rgw_ch $
 *******************************************************************************/
...
public class SimpleWidgetProvider implements WidgetProvider{
	...
	public StructuredViewer createViewer(Composite parent) {
		switch(type){
			case TYPE_TREE: return new TreeViewer(parent);
			case TYPE_LIST: return new ListViewer(parent,style);
			case TYPE_TABLE: return new TableViewer(parent,style);
			case TYPE_LAZYLIST:	
