...
/**
 * Interface that defines a number of data types to expose and grant access to
 * them
 * 
 * @author gerry
 * 
...
public interface IDataAccess {
	...
	public static class Element {
		...
		public Element(final TYPE typ, final String name, final String ph,
				final Class<? extends PersistentObject> ref,
		...
		public Element(TYPE typ, String name,
				Class<? extends PersistentObject> ref, int numOfParams) {
