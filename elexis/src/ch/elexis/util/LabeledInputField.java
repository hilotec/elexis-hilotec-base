 ...
 * darunter einem Control zur Eingabe besteht. Eignet sich besonders zur Verwendung
 * in einem ColumnLayout. 
 * @author Gerry
 *
 */
public class LabeledInputField extends Composite {
    ...
    /** 
     * Create an automatocally maintained form out of an array of InpuData[]. Usage:
       InputData[] id=new InputData[]{
       // ...
        };
       TableWrapLayout twl=new TableWrapLayout();
       setLayout(twl);
        AutoForm af=new LabeledInputField.AutoForm(parent,id));
