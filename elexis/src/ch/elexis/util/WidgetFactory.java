...
/**
 * Helferklasse zur Erzeugung von SWT-Widgets selbständig oder
 * innerhalb einer org.eclipse.ui.forms Form. Die in der Form erstellten
 * Elemente erhalten automatisch das Eclipse-look&feel und fügen sich dadurch
 * gut in Eclipse ein.
 * @author Gerry
 */
public class WidgetFactory {
	...
	/**
	 * Label erzeugen
	 * @param parent �bergeoirdnetes Composite
	 ...
	 * @param client  das Element, das aufgeklappt werden soll
	 * @param Text Der Text, der auf dem Composite stehen soll 
	 */
	public ExpandableComposite createExpandableComposite(Control client, String Text){
		ExpandableComposite ret=tk.createExpandableComposite(form.getBody(),ExpandableComposite.TWISTIE);
		ret.setText(Text);
    ...
    public static ExpandableComposite createExpandableComposite(final FormToolkit t ,final ScrolledForm f, String text){
	 ...
	 * @param text Angezeigter und anklickbarer Text
	 * @param lis HyperlinkListener oder (einfacher) HyperlinkAdapter, der die 
	 * Klicks verarbeiten kann
	 */
	...
	/** 
	 * Trennlinie in der Form erzeugen. Achtung:Breite und Höhe muss noch mit
	 * entsprechenden LayoutData festgelegt werden.
	 */
	...
	public static GridData getFillGridData() {
		GridData ret=new GridData(GridData.FILL_HORIZONTAL|GridData.FILL_VERTICAL|GridData.GRAB_HORIZONTAL|GridData.GRAB_VERTICAL);
		return ret;
	}
	public static GridData getHorzFillGridData(){
