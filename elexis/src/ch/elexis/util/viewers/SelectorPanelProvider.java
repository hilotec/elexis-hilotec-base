...
public class SelectorPanelProvider implements ControlFieldProvider {
	...
	public Composite createControl(Composite parent) {
		...
		for (FieldDescriptor<? extends PersistentObject> field : fields) {
			...
			case COMBO:
				ac = new ComboField(panel.getFieldParent(), 0,
						field.getLabel(), (String[]) field.getExtension());
				break;
			case INT:
				ac = new IntegerField(panel.getFieldParent(), 0,
						field.getLabel());
			}
