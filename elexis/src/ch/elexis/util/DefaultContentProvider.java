 ...
 *    
 *  $Id: DefaultContentProvider.java 2208 2007-04-13 09:05:39Z danlutz $
 *******************************************************************************/
...
/** 
 * Default-Implementation des ContentProviders. Zeigt eine Liste der in der
 * Datenbank vorhandenen Elemente einer bestimmten Klasse an. 
 * @author Gerry
 *
 */
public class DefaultContentProvider implements CommonContentProvider{
	...
	public Object[] getElements(Object inputElement) {
        ...
        if(list==null){
            return new String[]{Messages.getString("DefaultContentProvider.noData")}; //$NON-NLS-1$
        }else{
            return list.toArray();
        }
	}
