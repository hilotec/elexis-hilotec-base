 ...
 * sie immer dann via doXref aufgerufe, wenn der Benutzer den von ihr gesetzten
...
public interface IKonsExtension extends IExecutableExtension {
	 ...
	 * @param provider
	 *            den Provider-String, den diese IKonsExtension dem
	 *            Extension-Point angegeben hat
	 * @param id
	 *            die ID, die die IKonsExtension dieser Textstelle zugewiesen
	 *            hat
	 * @return true wenn der Text auch als Hyperlink funktionieren soll. styleRange.length muss
	 * dann >0 sein. 
	 */
	public boolean doLayout(StyleRange styleRange,  final String provider,
			final String id);
	...
	/**
	 * Anwender hat eine XRef gelöscht -> ggf. damit verbundene Daten müssen
