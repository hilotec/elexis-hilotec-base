...
/** 
 * Funktionalität für einen CommonViewer bereitstellen. Der ViewerConfigurer
 * ist ein Container für eine Anzahl xyProvider für je eine Eigenschaft des Viewers
...
public class ViewerConfigurer{
	...
	/**
	 * Der einzige Konstruktor. Alle Provider müssen gesetzt werden.
	 */
    public ViewerConfigurer(
            CommonContentProvider cnp,
            LabelProvider lp,
	...
	/**
	 * Defaultimplementation des Buttonproviders. Liefert einen Button, der
	 * ein neues PersistentObject anhand der ausgewählten Felder erstellt, und
	 * der nur dann aktivierbar ist, wenn die Anzeigeliste leer ist.
	 * Wenn man den leeren Konstruktor benutzt, wird kein Button erzeugt.
	 * @author Gerry
	 *
	 */
            ...
            ret.addSelectionListener(new SelectionAdapter(){
                ...
                public void widgetSelected(SelectionEvent e) {
                	if(dlg!=null){
                		...
                		Hub.poFactory.create(clazz,
	                            ((DefaultControlFieldProvider)vcf.getConfigurer().getControlFieldProvider()).getDBFields(),
