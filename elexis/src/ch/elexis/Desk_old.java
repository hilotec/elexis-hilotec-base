 ...
 *    
 *    $Id: Desk_old.java 3918 2008-05-13 16:13:09Z rgw_ch $
 *******************************************************************************/
 ...
 * @deprecated
 */
public class Desk_old implements IPlatformRunnable {
	...
	public Object run(final Object args) throws Exception {
		...
		if(theImageRegistry==null){
			...
			synchronized(theImageRegistry){
		        ...
		        theImageRegistry.put(IMG_LOCK_CLOSED, Hub.getImageDescriptor("rsc/emblem-readonly.png"));  //$NON_NLS-1$
			}
		}
		try {
