 ...
 *    
 *  $Id: DBConnectFirstPage.java 1183 2006-10-29 15:11:21Z rgw_ch $
 *******************************************************************************/
...
public class DBConnectFirstPage extends WizardPage {
	...
	static final String[] supportedDB=new String[]{"mySQl","PostgreSQL","hsqlDB (inProc)","hsqlDB (Server)"};
	public DBConnectFirstPage(String pageName) {
		super(Messages.getString("DBConnectFirstPage.Connection"),Messages.getString("DBConnectFirstPage.typeOfDB"),Hub.getImageDescriptor("rsc/elexis48.png")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public DBConnectFirstPage(String pageName, String title,
