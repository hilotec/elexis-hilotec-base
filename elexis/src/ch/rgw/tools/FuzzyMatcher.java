...
public class FuzzyMatcher
{
  ...
  { FuzzyMatcher ret=new FuzzyMatcher();
    ...
    log.log("create WLDMatcher level "+ret.level,Log.DEBUGMSG);
    return ret;
  }
  ...
  { FuzzyMatcher ret=new FuzzyMatcher();
    ...
    switch (level)
    {
      case 1: ret.level=5; break;
      case 2: ret.level=3; break;
      default: ret.level=2;
    }
    ret.pattern=SYPH_compile(pattern.trim(),ret.level);
    log.log("create SYPHMatcher level "+ret.level,Log.DEBUGMSG);
    log.log("pattern: "+ret.pattern,Log.DEBUGMSG);
    return ret;
  }
   ...
   *  Gibt "Distanz" zwischen Wort und Muster
  */
