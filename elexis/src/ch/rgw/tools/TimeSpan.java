...
{ public static String Version(){return "1.6.3";}
   ...
   * @param ti String der Form hh:mm[:ss]-hh:mm[:ss] oder einen String wie
  ...
  { set(ti);
    ...
    {	TimeSpan o=(TimeSpan)other;
        ...
        {	if(until.isBefore(o.until))
            	return -1;
            else
                return 1;
        }
        if(from.isBefore(o.from))
            	return -1;
   ...
   * @return eine neue timeSpan, die den überlappungszeitraum enthält oder
   * null, wenn keine überlappung vorliegt
   */
  public TimeSpan overlap(TimeSpan other)
  { /* Es sind 6 Fälle möglich:
  	   a) other ganz vor this
  	   b) other überlappt this.from
  	   c) other liegt ganz innerhalb this
  	   d) other überlappt this.until
  	   e) other liegt ganz nach this
  	   f) other überlappt this ganz
  	   ende oder Anfang auf selber Minute wird nicht als überlappung gerechnet.
  	   TimeSpan der Dauer null überlappt niemals
    */
   ...
   * @return <ul><li>IS_BEFORE-OTHER: Liegt ganz vor der anderen</li>
   ...
   * <li>IS_ZERO_LENGTH: Länge null sekunden</li></ul>
   */
   ...
   * {@link TimeTool#set} spezifiziert enthält. z.B. 10:00-11:30,
   * oder einen String im Kompaktformat wie 10001130, oder einen String wie
   * von toString() geliefert
...
public static int create(Collection c,String s)
  ...
  public static class TSComparator implements Comparator
  {

    public int compare(Object arg0, Object arg1)
    {  TimeSpan ts1=(TimeSpan)arg0;
       return ts1.compareTo(arg1);
    }
