...
{  public static String Version(){return "1.1.1";}
  ...
  /**
   * Ergänzt ein Long um eine Prüfsumme und wandelt das ganze in einen leicht
   * abtippbaren String, bestehend aus kurzen Zeichenfolgen um
   * @param num die Zahl
  ...
  /**
   * Holt einen Long-Wert aus einem envelope. Prüft, ob die Prüfsumme
   * korrekt ist.
   * @param env
   * @return
   */
