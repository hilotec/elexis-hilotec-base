...
public class FileTool {
	...
	/**
	 * Gibt das Basisverzeichnis von clazz resp. des Jars, in dem diese Klasse sich befindet zur�ck.
	...
	public static File resolveFile(String filepath){
		...
		Settings env = CfgSettings.open(".environment", "System Environment f�r java");
		while (m.find() == true) {
			String f = m.group(1);
