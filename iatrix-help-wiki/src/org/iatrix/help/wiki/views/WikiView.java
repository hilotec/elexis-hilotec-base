 ...
 * 
 * Interface Specification to Wiki:
 * - The View's class name is used
 * - The dot's are removed
 * - each component is converted to lowercases
 * - the first component character is set to uppercase
 * - the components are assembled to a WikiName
