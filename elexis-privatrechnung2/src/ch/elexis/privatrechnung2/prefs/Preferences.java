...
public class Preferences extends PreferencePage implements
	...
	private static final String[] ExtFlds={ESR5OR9, ESRPLUS}; //$NON-NLS-1$ //$NON-NLS-2$
	...
	class BankLister extends TitleAreaDialog{
		final String[] flds={BANK_NAME, BANK_LOCATION, ESRNUMBER, ESRSUB}; //$NON-NLS-1$ //$NON-NLS-2$
		Label banklabel;
