...
public class Artikel_AT extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public boolean performOk(){
		Hub.globalCfg.set(PreferenceConstants.ARTIKEL_AT_VIDAL_BENUTZERKENNUNG, benutzerkennung
			.getText().trim());
	...
	protected Control createContents(Composite parent){
		...
		benutzerkennung.setText(Hub.globalCfg.get(
		...
		new Label(ret, SWT.NONE).setText(Hub.globalCfg.get(
		...
		new Label(ret, SWT.READ_ONLY).setText(Hub.globalCfg.get(
		...
		new Label(ret, SWT.NONE).setText("Cache erstellt am "
			+ Hub.globalCfg.get(PreferenceConstants.ARTIKEL_AT_CACHEUPDATE_TIME, "n/a"));
