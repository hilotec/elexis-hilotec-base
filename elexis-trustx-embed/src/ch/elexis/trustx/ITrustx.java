...
public interface ITrustx extends Com4jObject {
    ...
    @VTID(8)
    @ReturnValue(defaultPropertyThrough={ch.elexis.trustx.ITrustxCollection.class})
    java.lang.String trustCenters(
        int index);
    ...
    @VTID(25)
    @ReturnValue(type=NativeType.VARIANT,defaultPropertyThrough={ch.elexis.trustx.IAsasCollection.class})
    java.lang.Object asasLogins(
        int idx);
