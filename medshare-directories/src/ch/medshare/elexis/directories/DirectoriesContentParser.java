...
public class DirectoriesContentParser extends HtmlParser {
	 ...
	 * 
	 * <div id="te_ojUHu3vXsUWJbXidz2_sRQ" onmouseover="lcl.search.onEntryHover(this)" onclick="if (typeof(lcl.search) != 'undefined') { lcl.search.navigateTo(event, 'http://tel.local.ch/de/d/ILwo-yKRTlguXS4TFuVPuA?what=Meier&start=3'); }"
	 ...
	 * entry does NOT begin with the <li class "detail">tag, but (quite probably, I've not perfectly
	 * reviewed it) with the <div data-slot="... tag.
	 * 
	 ...
	 * 
	 * <li class="detail"><img
	 * src="http://s.staticlocal.ch/2/74023/s/resultlist/images/localinfo/detail.png" alt="" /><a
	...
	private KontaktEntry extractListKontakt() throws IOException, MalformedURLException{
		...
		// which is a link to (I guess) searching all entries with the same role in the same
		// locality;
		...
		// the exemplary output obtained by searching for Anne Müller in Bern (who provides
		// Craniosacral Therapy)
		//
		// Example:
		//
		// </script></div><div id="results"><div id="singleview" class="vcard"><div
		// class="resrowclr_yellow"><br /><img class="imgbox"
		// src="http://s.staticlocal.ch/images/pois/na/blue.png" alt="poi" /><p class="role"><a
		// href="http://tel.local.ch/de/q/bern/Craniosacral Therapie.html"
		// title="Suche nach Craniosacral Therapie in bern">Craniosacral Therapie</a>; <a
		// href="http://tel.local.ch/de/q/bern/Massage Gesundheits- und Sport-.html"
		// title="Suche nach Massage Gesundheits- und Sport- in bern">Massage Gesundheits- und
		// Sport-</a>; <a href="http://tel.local.ch/de/q/bern/Gesundheitspraxis.html"
		// title="Suche nach Gesundheitspraxis in bern">Gesundheitspraxis</a></p><h2 class="fn">Anne
		// M&#xFC;ller</h2><p class="role">dipl. Physiotherapeutin Mitglied Cranio Suisse</p>
		//
		// N.B.: Anne Müller / Craniotherapy shows a role only in her detail_format output, but not
		...
		// BUT only the results from the list entry processing are transferred into the following
		// dialog.
		// I can see that definitely if I hard-code some variable content in the extractKontakt()
		// function,
