...
public class MandantSelectionContributionItem extends ContributionItem {
	...
	private ElexisEventListenerImpl eeli_mandant = new ElexisEventListenerImpl(
			Mandant.class, ElexisEvent.EVENT_MANDATOR_CHANGED) {
		public void runInUi(ElexisEvent ev) {
			ICoolBarManager icb = ((ApplicationWindow) PlatformUI
	...
	private Color getColorForMandator(Mandant m) {
		return Desk.getColorFromRGB(Hub.globalCfg.get(
				PreferenceConstants.USR_MANDATOR_COLORS_PREFIX + m.getLabel(),
				Desk.COL_GREY60));
	}
