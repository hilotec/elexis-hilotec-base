...
public class ESRRecord extends PersistentObject{
	...
	static{
		addMapping(TABLENAME,"ID","Datum=S:D:DATUM", //$NON-NLS-1$ //$NON-NLS-2$
	...
	public ESRRecord(final String file,final String codeline){
		...
		set(new String[]{"Datum","Eingelesen","Verarbeitet","Gutgeschrieben", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
