 ...
 * 
 * The type Problem is now an extension of Episode.
 * This class allows to load problems from the old-style table. This table
 * is now deprecated.
 * 
...
public class OldProblem extends PersistentObject {
    ...
    /**
     * Return a list of old-style problems.
     * This serves for compatibility purposes.
     */
    public static List<OldProblem> getOldProblems() {
    	Stm stm = j.getStatement();
    	String sql = "SELECT ID FROM " + PROBLEM_TABLENAME + ";";
		List<String> ids = stm.queryList(sql.toString(), new String[] {"ID"});
