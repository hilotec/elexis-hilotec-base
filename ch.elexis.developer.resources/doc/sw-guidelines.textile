...
The release plan is maintainded under "roadmap":http://sourceforge.net/apps/mediawiki/elexis/index.php?title=Roadmap
...
Changes in the database layout have a big potential to upset users and/or developers if suddenly fields change type, name or semantics or are dropped.
