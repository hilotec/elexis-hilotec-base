...
public class ACLContributor implements IACLContributor {
	...
	public static final ACE MY_NODE =
		new ACE(ACE.ACE_ROOT, Activator.PLUGIN_ID, SAMPLE_ACE_TRANSLATABLE_NODE_NAME);
	/**
	...
	public static final ACE ModifySDT =
		new ACE(MY_NODE, Activator.PLUGIN_ID + "_modifySDT", SAMPLE_ACE_MODIFY); //$NON-NLS-1$
	
	public static final ACE CreateSDT =
		new ACE(MY_NODE, Activator.PLUGIN_ID + "_createSDT", SAMPLE_ACE_CREATE); //$NON-NLS-1$
	
	public static final ACE DeleteSDT =
		new ACE(MY_NODE, Activator.PLUGIN_ID + "_deleteSDT", SAMPLE_ACE_DELETE); //$NON-NLS-1$
