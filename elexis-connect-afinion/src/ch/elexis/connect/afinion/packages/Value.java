...
public class Value {
	...
	public static Value getValue(final String paramName, final String unit)
	...
	private void initialize() {
		...
		if (list.size() < 1) {
			myLab = new Labor(Messages.getString("Value.LabKuerzel"), Messages
