...
public class PluginDataProvider extends AbstractTimeSeries {
	 ...
	 */
	@GetProperty(name = "Abfrage", index = 0,
		description = "Zu benutzende Abfrage um die Daten zu sammeln",
		widgetType = WidgetTypes.VENDOR,
		vendorClass = OurComboWidget.class
		)
