...
% *
% *  $Id: elexis.tex 4282 2008-08-15 14:45:56Z rgw_ch $
% *******************************************************************************
...
\index{Updates}
\textbf{Updates}
Ein Computerprogramm ist im Grunde niemals fertig. Nebst Fehlerbehebungen und Optimierung von Abläufen, gibt es immer wieder Dinge, die im Lauf der Zeit hinzukommen oder geändert werden müssen (z.B. Änderung gesetzlicher Vorgaben oder Tarifstrukturen etc.). Elexis macht Ihnen die Aktualisierung einfach: Mit jeder Elexis-Installation\footnote{Ab Version 1.3.4} wird auch ein Programm namens 'elexisupdate.exe' (unter windows) resp. 'elexisupdate.pl' (Unter Linux) resp. 'elexisupdate.script' (unter Mac) installiert. Verlassen Sie Elexis, starten Sie das Update-Programm, warten Sie, bis es seine Arbeit beendet hat, starten Sie Elexis wieder. 
