...
% *
% *  $Id: stammdaten.tex 4896 2009-01-02 08:23:59Z rgw_ch $
% *******************************************************************************
...
\subsubsection{Markierungen / Etiketten}
\index{Patienten!markieren}\index{Patienten!hervorheben}
Sie können die Anzeige der Patienteneinträge anhand bestimmter Kriterien beeinflussen. Diese Technik nennen wir hier 'Etiketten'. Jeder Patient kann null bis mehrere Etiketten haben, die dann sowohl in der Patientenliste als auch im Konsultationseintrag angezeigt werden. Genauere Angaben dazu finden Sie unter \ref{Etiketten} auf S. \pageref{Etiketten};

Wie man Etiketten erstellen kann, ist in
Etiketten werden im Menü textsc{Datei-Einstellungen-Etiketten} erstellt.
...
\item Sie können ein Script aus der Sctip-View ins Filterfeld hineinziehen, welches beliebige Bedinungen errechnen kann.
\end{itemize}

Die Filterbedingungen werden strikt von oben nach unten abgearbeitet. Also der als zweites eingegebene Filterausdruck wird überhaupt nur dann ausgewertet, wenn der erste passiert wurde. Es ist deswegen sinnvoll, weniger rechenintensove Filter (z.B. Sticker) oben und rechenintensivere (z.B. Scripts) weiter unten einzusetzen.
Klicken Sie dann auf einen der Spaltenköpfe um die Liste neu - diesmal beeinflusst durch den Filter- einzulesen.
