...
% *    G. Weirich
% *
% *  $Id: konzepte.tex 2572 2007-06-23 11:09:43Z rgw_ch $
% *******************************************************************************
...
Jemand, der eine Rechnungsstelle (also eine eigene ZSR-Nummer) hat, ist ein \textit{Mandant}. Jeder Vorgang
in Elexis (Konsultation, Labor, Rezept etc.) läuft immer unter Verantwortung und auf Rechnung genau eines
...
Das Konzepr der Gruppen und Rechte ist ab Seite \pageref{sec:gruppen} ff.
genauer erklärt.
...
Jede Konsultation ist auch einem \textit{Fall} zugeordnet. Ein Fall ist hier eher eine versicherungstechnische, als eine medizinische Einheit: Der Fall sammelt alle Konsultationen, welche unter demselben Titel verrechnet werden. Dies kann manchmal identisch mit dem medizinischen Fallbegriff sein (Ein Unfall, welcher über einen bestimmten Versicherer mit einer bestimmten Fallnummer abgerechnet wird), oder er kann auch keinen Zusammenhang mit einem medizinischen Fall haben (z.B. wird in der Schweiz im Allgemeinen ein allgemeiner Fall \glqq Krankheit\grqq{} erstellt werden, der alle KVG-Konsultationen sammelt.
...
\index{Artikel}\index{Medikament}\index{Lager}
 ...
 Einzelne Elemente können auch mit Drag\&Drop zwischen den laufenden Instanzen
 ausgetauscht werden.
 Anwendungseispiele:
 \begin{itemize}
   ...
   möchten Sie nicht untätig herumsitzen. Kein Problem, starten Sie eine zweite
   ...
   das gewünschte mit Drag\&Drop oder Cut\&Paste.
 \end{itemize}
