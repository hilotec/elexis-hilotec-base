...
/**
 * A Stream that decompresses an earlier created HuffmanOutputStream
 * Tree and dynamic feature are read from the Stream header.
 * @author Gerry
 */
public class HuffmanInputStream extends InputStream
{   public static String Version(){return "0.5.4";}
