...
/**
 * Simple implementation of the Huffman compression algorithm. Consists solely of
 * static functions.<br>
 * To compress data:<ol>
 * <li>Load, create or use a frequency table for the data to compress: (Tree.constructTable(), Tree.loadTable(), Tree.useTable())</li>
 ...
 * <p>This implementation uses an extension to the straightforward algorithm to deal with 
 * the situation of a character being written, which was not in the table, and with 
 * end-of-file conditions. In such cases, an escape character (0x07) will be written and specially
 * interpreted</p> 
...
public class Huff
{
	public static String Version(){return "0.6.4";}
     ...
     * @param source the source to compress. If tree is null, the Tree will
     * be computed from the source first and its frequency table is included 
     * in the output.
     ...
     * @param source A huffman compressed array as returned by encode(). If
     * tree is null, the frequency count is expected to be included to the source.
     ...
     * an escape sequence is generated (leading to an increase of the total size of the
     * compressed file)
    ...
    /**
     * Read a huffman encoded byte: read as many bits as necessary out of
     * the InputStream an return the resulting byte.
     * manages escape codes.
     * @param act   The root node of the Huffman tree
     ...
     * storage of Huffman tables.:<ul>
     * <li>java -classpath . ch.rgw.tools.Compress.Huff list: shows all stored tables
     * in the system Preferences</li>
     * <li>java -classpath . ch.rgw.tools.Compress.Huff create <name> <file>: computes
     * a frequency table of the <file> and stores ist as <name> in the preferences.</li>
     * <li>java -classpath . ch.rgw.tools.Compress.Huff export <name> <file>: exports
     * the table <name> from the preferences into two files:<ul>
     * <li><file>.bin: A binary representation (sequence of bytes)</li>
     * <li><file>.asc: A textual representation (comma separated list)</li></ul>
     * </li>
     * </ul>
     */
