...
public class ExHandler {
		...
		if ((name == null) || (name.equals("")) || (name.equals("none"))) {
			...
			try {
				...
				System.err.println(Messages
						.getString("ExHandler.cantRedirectOutput")); //$NON-NLS-1$
			}
		}
	}
	...
	/**
	 * Interessierende Klassen setzen (Präfixe). (Nur die Klassen mit dieser
	 * Präfix werden im Stack-Trace ausgegeben. Wenn keine angegeben werden,
	 ...
	 * message der Exception und einen Stack-Trace der interessierenden Klassen
	 * aus.
	 * 
	 * @param ex
	 *            die Exception
