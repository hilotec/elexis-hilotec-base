...
/**
 * This class is a java representation of a vCard
...
public class VCard {
	...
	/**
	 * Construct a VCard from an InputStream. If the stream contains more than one vCard,
	 * only one will be loaded
	 * @param in the Stream containing the vCard-Data
	 * @throws VCardException inf the stream does not contain a valid vCard
	 * @throws IOException 
	 */
