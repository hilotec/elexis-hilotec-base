...
public class Log {
	...
	private Level translate (int logLevel){
		switch(logLevel){
		case NOTHING: return Level.FINEST;
		case FATALS: return Level.SEVERE;
		case ERRORS: return Level.SEVERE;
		case WARNINGS: return Level.WARNING;
		case INFOS: return Level.INFO;
		case DEBUGMSG: return Level.FINE;
		case TRACE: return Level.ALL;
		case SYNCMARK: return Level.ALL;
