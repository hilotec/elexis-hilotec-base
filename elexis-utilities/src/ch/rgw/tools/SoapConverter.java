...
/**
 * We try to make a simple converter from and to SOAP without the huge overhead
 * of Axis... This implementation deals only with a limited number of variable
 * types.
 * 
 * @author Gerry
 * 
...
public class SoapConverter {
	...
	public void addMap(Element parent, String name,
