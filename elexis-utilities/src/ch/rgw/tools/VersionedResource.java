...
/**
 * Eine VersionedResource ist ein Datenobjekt, das einen String-Inhalt so speichert,
 * dass bei einer neuen Speicherung der alte Inhalt nicht überschrieben, sondern
 * mit Zeitstempel aufbewahrt wird. Zu einem späteren Zeitpunkt kann jede frühere
 * Version wiederhergestellt werden. 
 * Die innere Implementation des Versionsalgorithmus ist transparent. Es ist sowohl
 * eine simpke speicherung aller Versionen, als auch eine Speicherung eines Diff 
 * möglich. Abgeleitete Klassen könnten auch die alten Versionen extern ablegen etc.
 * Zur Rückwärtskompatibiltät kann VersionedResource auch mit CompEx-gepackten
 * Strings umgehen: Diese werden beim ersten Einlesen in VersionedResourcen umgewandelt.
 * @author Gerry
 *
 */
public class VersionedResource {
     ...
     * @return false, wenn kein updatze erfolgte (z.B. weil die neue
     * Version identisch mit der vorherigen war)
     */
     ...
     * @return der Dateninhalt in der gewünschten Version oder Null, wenn
     * die gewünschte Version nicht existiert. Der zurückgelieferte Text enthält
     * einen einzeiligen Header, der die Versionsmummer, Zeit/Datum der Erstellung
     * und den Anmerkungstext enthält.
     */
    ...
    public static class ResourceItem implements Serializable{
        ...
        public String getLabel(){
            ...
            sb.append(new TimeTool(timestamp).toString(TimeTool.FULL_GER))
