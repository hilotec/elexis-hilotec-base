...
public static final String Version(){return Messages.getString("InMemorySettings.0");} //$NON-NLS-1$
	 ...
	 * @param preset Arrays aus Strings der form Name=wert
	 */
	...
	{	
	    for(int i=0;i<preset.length;i++){
	        ...
	        if(pair.length!=2){
	            log.log(Messages.getString("InMemorySettings.badDefinition")+preset[i],Log.ERRORS); //$NON-NLS-1$
	        }
	 ...
	 * @param compressed eine
	 * mit {@link StringTool#fold(byte[], int, Object)} erstellte komprimierte
	 * Hashtable
	 */
	 ...
	 * @param preset ein mit {@link StringTool#enPrintable(byte[])} erstellter String
	 */
	public InMemorySettings(String preset)
	{
	 ...
	 * @return ein komprimiertes ByteArray, das als Parameter für 
	 * den Konstrukltor ByteArray dienen kann.
	 */
