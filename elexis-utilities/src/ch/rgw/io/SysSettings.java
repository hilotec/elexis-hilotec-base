 ...
 * Unter Windows ist das die Registry, unter Linux eine .datei in XML-Format.
 * Es wird unterschieden zwischen anwendnerspezifischen Settings (USER_SETTINGS)
 * und systemweiten Settings (SYSTEM_SETTINGS)  
 */
...
public static final String Version(){return "1.0.2";}
     ...
     * @param type USER_SETTINGS oder SYSTEM_SETTINGS
     * @param cl Basisklasse für den Settings-zweig
     */
