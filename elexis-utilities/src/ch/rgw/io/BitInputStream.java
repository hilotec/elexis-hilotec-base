...
{   public static final String Version(){return "0.3.3";}
    private int buffer;
    private int pos;
    InputStream stream;
     ...
     * CAUTION: The returned number does <b>not</b> accurately indicate
     * the number of waiting bits (Only zero or non-zero is guaranteed)
     */
