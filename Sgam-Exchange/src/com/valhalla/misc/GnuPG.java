//$Id: GnuPG.java 1301 2006-11-20 20:15:14Z rgw_ch $
...
/**
  ...
  * <P>
  * 
  * It calls gpg (GnuPG) program to do all the PGP commands. $Id: GnuPG.java 1301 2006-11-20 20:15:14Z rgw_ch $
  * 
...
public class GnuPG {
 ...
 private Settings cfg;
 	private static Log log=Log.get("GnuPG");
  ...
  */
 public GnuPG() {
	 cfg=Hub.localCfg.getBranch("exchange", true);
	 String exe=cfg.get(PreferenceConstants.EXCH_GPG, "gpg");
	 File exeFile=new File(exe);
	 if(!exeFile.exists()){
		 SWTHelper.showError("GPG nicht gefunden", "Das GPG Programm wurde nicht gefunden. Bitte kontrollieren Sie die xChange - Einstellungen (Datei-Einstellungen)");
		 log.log("pgp not found "+exe, Log.ERRORS);
		 gpgOK=false;
	 }else{
		 gpgOK=true;
	 }
 ...
 public String decryptExtension(String xEncryptedData) {
	 ...
	 String gnupgPassword=cfg.get("gnupgPassword", null);
