 ...
 * 
 *    $Id: SampleDataType.java 6094 2010-02-09 06:06:06Z rgw_ch $
 *******************************************************************************/
...
/**
 * This is an example on how to derive your own type from PersistentObject and
 * make it persistent
 * 
 * @author gerry
 * 
...
public class SampleDataType extends PersistentObject {
	public static final String FLD_FUNNY_STUFF = "FunnyStuff";
	public static final String FLD_BOREFACTOR = "Bore";
	public static final String FLD_FUNFACTOR = "Fun";
	public static final String FLD_TITLE = "Title";
	static final String VERSION = "1.0.0";
	/**
	 * The Name of the Table objects of this class will reside in. If a plugin
	 * creates its own table, the name MUST begin with the plugin ID to avoid
	 * name clashes. Note that dots must be replaced by underscores due to
	 * naming restrictions of the database engines.
	 */
	...
	static final String createDB = "CREATE TABLE "
			...
			+ "insert into " + TABLENAME + " (ID,Title) VALUES (VERSION,"
			+ VERSION + ");";
	 ...
	 */
	static {
		addMapping(TABLENAME, FLD_TITLE, "Fun=FunFactor", "Bore=BoreFactor",
				"Date=S:D:Date", "Remarks", FLD_FUNNY_STUFF);
	...
	/**
	 * Create a new Object. Any constructor except the empty constructor and the
	 * constructor with a single String argument are possible
	 * 
	 * @param title
	 * @param funFactor
	 * @param boreFactor
	 */
	public SampleDataType(String title, int funFactor, int boreFactor) {
		...
		set(new String[] { FLD_TITLE, FLD_FUNFACTOR, FLD_BOREFACTOR }, title,
				Integer.toString(funFactor), Integer.toString(boreFactor));
	...
	/**
	 * This should return a human readable short description of this object. The
	 * getLabel Method should be fast because it is called frequently.
	 */
	@Override
	public String getLabel() {
		...
		synchronized (sb) {
			sb.append(result[0]).append(" has fun factor:").append(result[1])
					.append(" and bore factor ").append(result[2]);
		}
		return sb.toString();
	}
	...
	/**
	 * This must return the name of the Table this class will reside in. This
	 * may be an existent table or one specificallym created by this plugin.
	 */
	@Override
