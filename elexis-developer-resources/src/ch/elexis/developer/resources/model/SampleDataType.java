...
public class SampleDataType extends PersistentObject {
	 ...
	 * @param boreFactor
	 */
	public SampleDataType(Patient pat, String title, int funFactor,
			int boreFactor) {
		...
		set(new String[] { FLD_PATIENT_ID, FLD_TITLE, FLD_FUNFACTOR,
				FLD_BOREFACTOR }, pat.getId(), title, Integer
				.toString(funFactor), Integer.toString(boreFactor));
