...
Documentation is in .textile format, which is supported by the mylin wikitext editor. Documentation can easily be converted into html, DocBook, or XSL-FO/PDF.
