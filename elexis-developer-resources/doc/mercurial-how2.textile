...
(Maybe you'll have to change some firewall rules, though). By default, users have only read access (i.e. _clone_).
...
Having set up your repository for sharing gives you an additional feature for free: Web access to your repository. Simply point your favorite web browser to the url of your repository. 
