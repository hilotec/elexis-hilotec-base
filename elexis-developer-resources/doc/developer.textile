...
p(klein). (c) 2010 by G. Weirich
 $Id: developer.textile 6303 2010-04-26 20:25:44Z niklausgiger $	
...
** h2-adapter
** postgresql-adapter
* elexis-developer-resources (recommended sample plugin)
...
Since April 2010 we are starting to use Hudson ("http://hudson-ci.org":http://hudson-ci.org) as a CI ("Continuos Integration":http://en.wikipedia.org/wiki/Continuous_integration) tool. It's output can be found at "http://ngiger.dyndns.org/":http://ngiger.dyndns.org/hudson. It will probably take months if not several years to achieve a good coverage of the whole elexis code base.
