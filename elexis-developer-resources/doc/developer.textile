...
p(klein). (c) 2010 by G. Weirich
 $Id: developer.textile 6264 2010-04-13 21:33:24Z niklausgiger $	
...
It is recommended to document your work. Besides of the javadoc, we recommend that you include at least a 'readme.txt' or 'whatisit.textile' file in the root of your plugin that describes, what it does and what it depends on. If you want to give your users a more elaborate documentation, it should be included in a folder called doc at the root of your plugin.
...
* Build. We will just generate all needed jars for the elexis kernel and the most commonly used plugins.

* JUnit. We will add JUnit tests, wherever we find time for it. We will focus on the areas where the benefit/cost-ratio is best.
