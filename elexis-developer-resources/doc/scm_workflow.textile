...
# Eclipse A: Add a new project P2 (e.g. elexis-kernel)
# Eclipse A: Commit new P2 as change C2
# Eclipse A: Push it to the remote server
...
!images/hg_clone_2.png!
By pressing several times "Next" we have a new workspace populated by the project "BuildElexis".
!images/hg_clone_3.png!
!images/hg_clone_4.png!
!images/hg_clone_5.png!

Now we open a second eclipse **workspace A** at /opt/gerry/A. Use "File..Import..Existing projects" to import the "BuildElexis" project.
...
Now we call on the command link @svn export https://elexis.svn.sourceforge.net/svnroot/elexis/trunk/elexis-kernel /opt/gerry/A/elexis-kernel@. Import this new project into your workspace A.

In the package explorer select "elexis-kernel". In the context menu we choose "Team..Commit..". In the "Mercurial Commit" you may use the "Select/Unselect all" button to include all files for commiting.
!images/hg_import_1.png!

As before we push using "Team..Push.." this change to the RemoteServer.
