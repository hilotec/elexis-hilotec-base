h1. SW guidelines (preliminary version 0.1 as of march 27 2011)

p(klein). (c) 2010-2011 by G. Weirich and Niklaus Giger
 $Id$	
...
We strive to release a new version every 3 months. At the moment the following release dates are schedules: 
* 2.1.5: end of June 2011
* 2.1.6: end of September 2011 and 
* 2.1.7: end of December 2011
...
You may name your plug-in whatever you like but we recommend that you prefix it with your name or the name of your organization.  The prefix ch.elexis is reserved for open source plug-ins under the Eclipse Public License. The name must be same as the plug-in-ID. 
...
* Open/LibreOffice-Writer (the extension must be .odt)
* LaTex (the extension must be .tex)
* HTML (the extension must be .html)
