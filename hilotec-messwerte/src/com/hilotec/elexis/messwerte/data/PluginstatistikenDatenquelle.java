 ...
 * Pluginstatistiken-Plugin ueber Messwert:Messungstyp zugegriffen werden.
 * Die Spaltennamen werden aus den Feldnamen im Messwertplugin uebernommen.
 * Zusaetzlich sind bei jedem Messwert zwei weitere Spalten mit Namen
 * Patient und Datum vorhanden. Ersteres gibt die ID des zugehoerigen
 * Patienten zurueck, waehrend zweiters dem Datum der Messung entspricht.
 * Wenn gleichbenannte Felder existieren werden diese ignoriert, und die
 * oben angegebenen Spezialbedeutungen werden benutzt.
 *  
...
public class PluginstatistikenDatenquelle implements IDatenquelle {
	...
	/**
	 * Einzelne Tabelle in dieser Datenquelle. Diese repraesentiert jeweils
	 * einen bestimmten Messungstyp.
	 * 
	 * @author Antoine Kaufmann
	 */
	private static class MessungTabelle implements ITabelle {
		...
		/**
		 * Konstruktor. Initialisiert eine neue Tabelle auf Basis des
		 * uebergebenen Messungstyps.
		 * 
