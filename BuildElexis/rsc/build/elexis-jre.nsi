; $Id: elexis-jre.nsi 2639 2007-06-27 16:05:37Z rgw_ch $
...
;OutFile "../../output\elexis-win32-${VERSION}-jre.exe"
OutFile "$%SOFTWARE%\elexis\deploy\output\elexis-jre-win32-${VERSION}.exe"
...
; Die Java runtime. Optional
Section "Java Runtime" SectionJ
    SetOverwrite ifnewer
    SetOutPath "$INSTDIR"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    ...
    !insertmacro MUI_DESCRIPTION_TEXT ${SectionJ} "Die Java Runtime"
...
BrandingText "Copyright (c) by Elexis 2005-2007"
